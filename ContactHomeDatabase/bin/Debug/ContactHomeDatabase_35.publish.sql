...
GO
/*
The column [dbo].[Products].[SubCategoryId] is being dropped, data loss could occur.
...
GO
/*
The column [dbo].[SubCategories].[CategoryId] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[SubCategories])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Products] ([Id], [Name], [Price], [Description], [Image])
        SELECT   [Id],
                 [Name],
                 [Price],
                 [Description],
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_SubCategories] ([Id], [Name])
        SELECT   [Id],
                 [Name]
        FROM     [dbo].[SubCategories]
        ORDER BY [Id] ASC;
