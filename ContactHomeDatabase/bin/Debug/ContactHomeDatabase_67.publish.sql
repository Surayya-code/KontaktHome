...
GO
/*
The column [dbo].[Files].[DeleteDate] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[Files])
...
GO
ALTER TABLE [dbo].[Files] DROP COLUMN [DeleteDate];
