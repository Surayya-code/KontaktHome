...
GO
/*
The column [dbo].[Products].[Image] is being dropped, data loss could occur.
*/
...
GO
PRINT N'Dropping [dbo].[FK_Products_Files]...';


GO
ALTER TABLE [dbo].[Products] DROP CONSTRAINT [FK_Products_Files];
